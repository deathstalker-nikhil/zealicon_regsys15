...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Generate Receipts</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                      ...
                                      <?php
$ar='';
		$query="SELECT * FROM `paid_registrations` WHERE `receipt`='0' ORDER BY `zealId`";
		$a1 = array();
		$a2 = array();
		$a3 = array();
...
?>
		...
		echo "<form name='form' method='POST' action='receiptgen.php'>
