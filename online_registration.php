                ...
                <div class="col-lg-9">
                        ...
                        if (isset($_POST['submit'])) {
                                $zealicon_id = $_REQUEST['zealicon_id'];
                                  $query0 = "SELECT * FROM online_registrations where `zealId`='$zealicon_id'";
                      ...
                      <div class="col-lg-6">
                            ...
                            <div class="row">
                                    <form role="form" action="confirm_registration.php" method="post">
                                      ...
                                      <input type="hidden" name="college" value="<?php echo $college; ?>">
                                       ...
                                       <div class="form-group"><label>Outside JSS:</label><input type="checkbox" name="checkjss" value="1" class="form-control"></div>
                  ...
                  <?php      
                        ...
                        if($flag==2){
                        echo "Zealicon ID not found in online registrations!!";
                        }
                        }
                                        ?>
